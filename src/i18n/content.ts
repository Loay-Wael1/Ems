...
export const siteContent = {
  ...
  ar: {
    meta: {
      ...
      description:
        'جلسات EMS Premium في الإسكندرية مع كوتش متخصص: تمرين كامل في 20 دقيقة يساعدك تتمرن بذكاء وتتابع هدفك بوضوح.',
      schemaDescription: 'أول EMS Studio في الإسكندرية لجلسات EMS موجهة مع كوتش متخصص.'
    },
    layout: {
    ...
    hero: {
      title: '20 دقيقة EMS.',
      titleAccent: 'تمرين أذكى لجسم أوضح.',
      description:
        'جلسة موجهة مع كوتش متخصص تنشّط عضلات الجسم بعمق، وتديك تمرين كامل في وقت أقل — من غير ساعات طويلة في الجيم.',
      primaryCta: 'احجز تجربة EMS',
      secondaryCta: 'شوف التحوّلات',
      badgesAriaLabel: 'مميزات Easy Fit',
      badges: [
        { label: 'EMS في 20 دقيقة', href: '#what-is-ems' },
        { label: 'كوتش + تغذية', href: '#expert-coaches' },
        { label: 'آراء العملاء', href: '#testimonials' },
        { label: 'فروع الإسكندرية', href: '#locations' }
      ]
    },
    beforeAfter: {
      title: 'نتائج واضحة… ومجهود محسوب.',
      intro:
        'تحوّلات حقيقية من عملاء Easy Fit Alexandria مع جلسات EMS مركّزة، متابعة كوتش، وخطة تساعدك تكمل.',
    ...
    ems: {
      eyebrow: 'أنظمة EMS',
      title: '20 دقيقة EMS تغيّر شكل تمرينك',
      intro: 'اختار النظام الأنسب لهدفك: حركة، شد، أو تشكيل مركز.',
      tablistLabel: 'أنظمة EMS',
      cta: 'احجز تجربة الـ20 دقيقة',
      systems: [
        {
          name: 'I-MOTION',
          tagline: 'EMS للجسم بالكامل، للحركة والقوة.',
          description: 'جلسة نشطة مع كوتش تساعد جسمك كله يشتغل بكفاءة في وقت قصير.',
          chipsLabel: 'مميزات I-MOTION',
          chips: ['تنشيط كامل للجسم', 'متابعة كوتش', 'نظام 20 دقيقة'],
          best: 'الأفضل للتدريب الكامل وتحسين شكل الجسم العام.'
        },
        {
          name: 'I-MODEL',
          tagline: 'EMS موجه للشد والتناسق.',
          description: 'تركيز أدق على مناطق زي البطن، الأرداف، والفخذين حسب هدفك.',
          chipsLabel: 'مميزات I-MODEL',
          chips: ['تشكيل مركز', 'مساعدة على الشد', 'جلسات جمالية'],
          best: 'الأفضل للشد وتحديد شكل الجسم.'
        },
        {
          name: 'I-SHAPE',
          tagline: 'EMS متقدم للجزء السفلي: الأرداف والرجلين.',
          description: 'نظام مركز لتشكيل الجزء السفلي بجلسات Premium عالية القيمة.',
    ...
    proof: {
      title: 'ليه EMS مش زي التمرين العادي؟',
      intro:
        'لأن الجلسة مش معتمدة على المجهود بس… هي تمرين موجه، محسوب، وكل دقيقة فيه بتخدم هدفك.',
      cards: [
        {
          title: 'تنشيط أعمق',
          text: 'نبضات EMS بتشتغل مع الحركة، فتساعد عضلات أكتر تدخل في التمرين بكفاءة أعلى.'
        },
        {
          title: 'كوتش بيتابعك لحظة بلحظة',
          text: 'الشدة بتتظبط حسب جسمك وإحساسك، عشان الجلسة تبقى قوية وآمنة ومناسبة ليك.'
        },
        {
          title: 'تمرين كامل في وقت أقل',
          text: '20 دقيقة منظمة تخلي الجسم كله يشتغل، من غير وقت طويل ولا تمرين عشوائي.'
        },
        {
          title: 'خطة ماشية مع هدفك',
          text: 'سواء هدفك شد، نزول دهون، قوة، أو رجوع للتمرين — الخطة بتتعدل مع تقدمك.'
        }
      ]
    },
    coaches: {
      kicker: 'متابعة متخصصة',
      title: 'كوتش حقيقي معاك في كل جلسة EMS.',
      intro:
      ...
      trustCards: [
        {
          title: 'جلسات PT خاصة',
          text: 'كل حركة، وضعية، ومستوى شدة بيكون تحت متابعة كوتش متخصص.'
        },
        {
          title: 'توجيه تغذية عملي',
          text: 'نساعدك بخطوات غذائية مناسبة لهدفك وتقدمك.'
        },
        {
          title: 'متابعة InBody',
          text: 'نقيس تكوين الجسم، مش الوزن بس، عشان تشوف التقدم بوضوح.'
        },
        {
          title: 'متابعة كل 14 يوم',
          text: 'بنراجع الخطة ونعدلها حسب استجابة جسمك.'
        }
      ],
      videos: [
        {
